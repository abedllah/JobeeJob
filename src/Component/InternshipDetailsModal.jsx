      ...
      <div className="bg-white border-2 border-gray-200 rounded-2xl shadow-lg w-full max-w-3xl max-h-[90vh] overflow-y-auto p-6 relative">
        ...
        <div className="flex justify-between items-start border-b pb-4">
          <div>
            ...
            <h2 className="text-2xl font-bold text-gray-800 mt-1">{internship.title}</h2>
        ...
        <div className="mt-6 text-sm text-gray-700">
          <p><strong>internship Types:</strong> {internship.type}</p>
          <p><strong>Pay:</strong> {internship.salary}</p>
          <p><strong>Schedule:</strong> {internship.schedule}</p>
          <p><strong>Work Location:</strong> {internship.location}</p>
        </div>
        ...
        <div className="mt-8">
          ...
          <ul className="text-sm text-gray-700 space-y-1">
            <li><strong>Size:</strong> {internship.companyInfo.size}</li>
            <li><strong>Founded:</strong> {internship.companyInfo.founded}</li>
            <li><strong>Type:</strong> {internship.companyInfo.type}</li>
            <li><strong>Industry:</strong> {internship.companyInfo.industry}</li>
            <li><strong>Sector:</strong> {internship.companyInfo.sector}</li>
            <li><strong>Revenue:</strong> {internship.companyInfo.revenue}</li>
          </ul>
        </div>
